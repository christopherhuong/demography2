...
m2 <- glm(PA~ ACE_CAT_SUM + AGE + SEX + EDU,
          data = df,
          family = binomial(logit))
...
# education is best predictor of physical activity
# graduate education is associated with 4.5x odds of PA compared to no HS

me2 <- margins(m2, variables = c("EDU"))
summary(me2)

# graduate education is associated with 28% greater probability of PA compared to no HS
